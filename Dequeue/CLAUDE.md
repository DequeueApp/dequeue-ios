...
**NEVER push code without testing it locally first!**
- Run `swiftlint` before committing
- Run `⌘U` or `xcodebuild test` for test changes
- Run `⌘B` to verify builds before pushing
- **ESPECIALLY for UI tests** - run them locally, verify they pass, THEN push
- Don't waste time waiting for 10+ minute CI runs when you could test in 2 minutes locally
