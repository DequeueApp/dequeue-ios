...
struct SyncManagerWebSocketStreamTests {
    ...
    func testSyncStreamStartDeserialization() throws {
        ...
        #expect(start.totalEvents == 10_000)
    }
    ...
    func testSyncStreamCompleteDeserialization() throws {
        ...
        #expect(complete.processedEvents == 10_000)
    ...
    func testBatchSizeCalculations() {
        ...
        let cases: [TestCase] = [
            ...
            TestCase(totalEvents: 10_000, batchSize: 100, expectedBatches: 100),
    ...
    func testStreamingPerformanceEstimates() {
        ...
        let cases: [PerformanceCase] = [
            ...
            PerformanceCase(name: "Medium (1000 events)", eventCount: 1_000, batchSize: 100, estimatedSeconds: 3),
            PerformanceCase(name: "Large (10000 events)", eventCount: 10_000, batchSize: 100, estimatedSeconds: 15)
        ]
