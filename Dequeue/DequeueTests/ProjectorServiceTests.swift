...
struct ProjectorServiceTests {
    ...
    func updateStackRestoresIsActive() async throws {
        ...
        let event = Event(eventType: .stackUpdated, payload: payload, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack.id)
    ...
    func applyStackCreatedSetsIsActive() async throws {
        ...
        let event = Event(eventType: .stackCreated, payload: payload, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stackId)
        context.insert(event)
        try context.save()
    ...
    func applyStackActivatedSetsIsActiveTrue() async throws {
        ...
        let event = Event(eventType: .stackActivated, payload: payloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack.id)
        context.insert(event)
        try context.save()
    ...
    func applyStackDeactivatedSetsIsActiveFalse() async throws {
        ...
        let event = Event(eventType: .stackDeactivated, payload: payloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack.id)
        context.insert(event)
        try context.save()
    ...
    func singleActiveAfterRehydration() async throws {
        ...
        let event1 = Event(eventType: .stackCreated, payload: payload1, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack1Id)
        let event2 = Event(eventType: .stackCreated, payload: payload2, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack2Id)
        let event3 = Event(eventType: .stackCreated, payload: payload3, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack3Id)
    ...
    func activationDeactivationMaintainsConstraint() async throws {
        ...
        let createEvent1 = Event(eventType: .stackCreated, payload: payload1, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack1Id)
        let createEvent2 = Event(eventType: .stackCreated, payload: payload2, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack2Id)

        // Deactivate stack1, activate stack2
        let deactivateData = try createEntityStatusPayload(id: stack1Id, status: "active")
        let deactivateEvent = Event(eventType: .stackDeactivated, payload: deactivateData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack1Id)

        let activateData = try createEntityStatusPayload(id: stack2Id, status: "active")
        let activateEvent = Event(eventType: .stackActivated, payload: activateData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack2Id)
    ...
    func applyStackActivatedEnforcesConstraint() async throws {
        ...
        let event = Event(eventType: .stackActivated, payload: payloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack2.id)
        context.insert(event)
        try context.save()
    ...
    func multipleActivationEventsLastWins() async throws {
        ...
        let createEvent1 = Event(eventType: .stackCreated, payload: payload1, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack1Id)
        let createEvent2 = Event(eventType: .stackCreated, payload: payload2, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack2Id)
        let createEvent3 = Event(eventType: .stackCreated, payload: payload3, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack3Id)
        ...
        let activateEvent1 = Event(eventType: .stackActivated, payload: activateData1, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack1Id)

        let activateData2 = try createEntityStatusPayload(id: stack2Id, status: "active")
        let activateEvent2 = Event(eventType: .stackActivated, payload: activateData2, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack2Id)

        let activateData3 = try createEntityStatusPayload(id: stack3Id, status: "active")
        let activateEvent3 = Event(eventType: .stackActivated, payload: activateData3, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack3Id)
    ...
    func deletedStackActivationIsIgnored() async throws {
        ...
        let createEvent = Event(eventType: .stackCreated, payload: createPayload, userId: "test-user", deviceId: "test-device", appId: "test-app", timestamp: createTime, entityId: stackId)
        ...
        let deleteEvent = Event(eventType: .stackDeleted, payload: deletePayloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", timestamp: deleteTime, entityId: stackId)
        ...
        let activateEvent = Event(eventType: .stackActivated, payload: activatePayloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", timestamp: activateTime, entityId: stackId)
        context.insert(activateEvent)
        try context.save()
    ...
    func stackDeletionSetsIsActiveFalse() async throws {
        ...
        let event = Event(eventType: .stackDeleted, payload: payloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: stack.id)
        context.insert(event)
        try context.save()
    ...
    func applyTaskCompletedUsesTaskId() async throws {
        ...
        let event = Event(eventType: .taskCompleted, payload: payloadData, userId: "test-user", deviceId: "test-device", appId: "test-app", entityId: task.id)
        context.insert(event)
        try context.save()
