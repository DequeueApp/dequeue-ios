...
struct DateMorningReminderTests {
    ...
    func morningReminderTimeReturns8AM() {
        ...
        let components = DateComponents(year: 2_026, month: 2, day: 20, hour: 15, minute: 45, second: 30)
        ...
        if let reminder = reminderTime {
            ...
            #expect(reminderComponents.year == 2_026)
    ...
    func morningReminderTimePreservesDateForMorning() {
        ...
        let components = DateComponents(year: 2_026, month: 6, day: 15, hour: 6, minute: 0, second: 0)
        let date = calendar.date(from: components)!
    ...
    func morningReminderTimeWorksForMidnight() {
        let calendar = Calendar.current
        let components = DateComponents(year: 2_026, month: 1, day: 1, hour: 0, minute: 0, second: 0)
        let date = calendar.date(from: components)!
    ...
    func morningReminderTimeWorksForEndOfDay() {
        let calendar = Calendar.current
        let components = DateComponents(year: 2_026, month: 12, day: 31, hour: 23, minute: 59, second: 59)
        let date = calendar.date(from: components)!
    ...
    func morningReminderTimeAtExact8AM() {
        let calendar = Calendar.current
        let components = DateComponents(year: 2_026, month: 3, day: 10, hour: 8, minute: 0, second: 0)
        let date = calendar.date(from: components)!
    ...
    func morningReminderTimeWorksForLeapDay() {
        ...
        let components = DateComponents(year: 2_028, month: 2, day: 29, hour: 14, minute: 30)
        let date = calendar.date(from: components)!
        ...
        if let reminder = reminderTime {
            ...
            #expect(reminderComponents.year == 2_028)
            #expect(reminderComponents.month == 2)
